...
Version  : 2.8.1
Release  : 45
URL      : https://cran.r-project.org/src/contrib/curl_2.8.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/curl_2.8.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1505674813
