...
Version  : 3.0
Release  : 46
URL      : https://cran.r-project.org/src/contrib/curl_3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/curl_3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1507299118
