...
Version  : 6.2.2
Release  : 129
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/curl_6.2.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/curl_6.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742849074
...
/usr/lib64/R/library/curl/tests/testthat/test-errors.R
...
/usr/lib64/R/library/curl/tests/testthat/test-parser.R
